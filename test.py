...
import asyncio
item = area(name='satellogic_1', date = '2022-01-01', area ='POLYGON((0 0,1 0,1 1,0 1,0 0))' , properties = {'name':'satellogic','crop':'wheat'})
name_str = 'satellogic_1'
pol = 'POLYGON((0 0,1 0,1 1,0 1,0 0))'
prop = {"name": "satellogic2","crop":"wheat"}
...
class Testing(unittest.TestCase):
    ...
    async def test_delete_item(self):
        res = await delete_item(name_str)
        self.assertIsNotNone(res)
